...
JSON11_TEST_CASE(json11_test) {
  ...
  std::cout << "simple_test: " << simple_test << "\n";
  ...
  std::cout << "comment_test: " << comment_test << "\n";
  ...
  JSON11_TEST_ASSERT(((Json)(Json::object{{"foo", nullptr}}))
                         .has_shape({{"foo", Json::NUL}}, err) == true);
  JSON11_TEST_ASSERT(((Json)(Json::object{{"foo", 1234567}}))
                         .has_shape({{"foo", Json::NUL}}, err) == false);
  JSON11_TEST_ASSERT(((Json)(Json::object{{"bar", 1234567}}))
                         .has_shape({{"foo", Json::NUL}}, err) == false);
}
